...
public interface IVideoPlayer {
    ...
    interface IPlayerCallback {
        ...
        /**
         * Called when media player rendering starts. At this point videoView black overlay is gone.
         */
        void onStart();
    ...
    /**
     * Seek the currently loaded video to the given position (milliseconds).
     */
     ...
     */
    void removePlayerCallback(IPlayerCallback callback);
}
